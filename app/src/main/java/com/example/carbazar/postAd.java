...
public class postAd extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(common.currentUser == null){
            Toast.makeText(postAd.this, "Sign in first", Toast.LENGTH_SHORT).show();
            Intent intent3 = new Intent(postAd.this, signin.class);
        ...
        mDialog = new ProgressDialog(postAd.this);
        ...
        selectCondition = findViewById(R.id.conditionSpinnerSelection);
        ...
        postBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isOnline()){
                    ...
                    Toast.makeText(postAd.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent1 = new Intent(postAd.this, MainActivity.class);
            ...
            case R.id.threedotsBTN_actionBar:
                Intent intent2 = new Intent(postAd.this, postBuyerAd.class);
            ...
            case R.id.myAdsBTN_actionBar:
                Intent intent3 = new Intent(postAd.this, myAds.class);
                startActivity(intent3);
                overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                finish();
                return true;
            ...
            compositeDisposable.add(iMyService.getMakes()
                    ...
                    .subscribe(new Consumer<Object>() {
                        ...
                        public void accept(Throwable throwable) throws Exception {
                            Toast.makeText(postAd.this, "Server Error!" +throwable.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }));
        }else{
            Toast.makeText(postAd.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
    ...
    ArrayAdapter<String> adapter = new ArrayAdapter<String>(getApplicationContext(),
        ...
        adapter = new ArrayAdapter<String>(getApplicationContext(),
                R.layout.spinner_layout, conditionSpinnerItems);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.chatbot_nav:
                //
                Intent intent1 = new Intent(postAd.this, chatbot.class);
                startActivity(intent1);
                overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                return true;
            ...
            case R.id.ar_vr_nav:
                //
                Intent intent2 = new Intent(postAd.this, ARHome.class);
                startActivity(intent2);
                overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                return true;
            ...
            case R.id.account_nav:
                //
                Intent intent3 = new Intent(postAd.this, account.class);
                startActivity(intent3);
                overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                return true;
    ...
    private void sendData(){
        ...
        if(title.getText().toString().contentEquals("") || title.getText().toString().length() < 4){
            Toast.makeText(postAd.this, "Enter a valid title",Toast.LENGTH_SHORT).show();
            title.requestFocus();
        ...
        if(city.getSelectedItemPosition() == 0 || city.getSelectedItemPosition() == 1){
            Toast.makeText(postAd.this, "Select your city",Toast.LENGTH_SHORT).show();
        ...
        if(selectMake.getSelectedItem() == null){
            Toast.makeText(postAd.this, "Select Make",Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(selectModel.getSelectedItemPosition() == 0 || selectModel.getSelectedItemPosition() == 1){
            Toast.makeText(postAd.this, "Select Model",Toast.LENGTH_SHORT).show();
        ...
        if(selectRegCity.getSelectedItemPosition() == 0 || selectRegCity.getSelectedItemPosition() == 1){
            Toast.makeText(postAd.this, "Select Registration City",Toast.LENGTH_SHORT).show();
        ...
        if(selectYear.getSelectedItemPosition() == 0 || selectYear.getSelectedItemPosition() == 1){
            Toast.makeText(postAd.this, "Select Year",Toast.LENGTH_SHORT).show();
        ...
        if(KMDriven.getSelectedItemPosition() == 0 || KMDriven.getSelectedItemPosition() == 1){
            Toast.makeText(postAd.this, "Select KMs Driven",Toast.LENGTH_SHORT).show();
        ...
        if(selectExteriorColor.getSelectedItemPosition() == 0 || selectExteriorColor.getSelectedItemPosition() == 1){
            Toast.makeText(postAd.this, "Select Exterior Color",Toast.LENGTH_SHORT).show();
        ...
        if(price.getText().toString().contentEquals("")){
            Toast.makeText(postAd.this, "Enter a valid price",Toast.LENGTH_SHORT).show();
            price.requestFocus();
            InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
            imm.toggleSoftInput(InputMethodManager.SHOW_FORCED, InputMethodManager.HIDE_IMPLICIT_ONLY);
            return;
        ...
        if(description.getText().toString().contentEquals("") || description.getText().toString().length() < 4){
            Toast.makeText(postAd.this, "Add a valid Description",Toast.LENGTH_SHORT).show();
        ...
        if(selectEngineType.getSelectedItemPosition() == 0 || selectEngineType.getSelectedItemPosition() == 1){
            Toast.makeText(postAd.this, "Select Engine Type",Toast.LENGTH_SHORT).show();
        ...
        if(selectTransmission.getSelectedItemPosition() == 0 || selectTransmission.getSelectedItemPosition() == 1){
            Toast.makeText(postAd.this, "Select Transmission",Toast.LENGTH_SHORT).show();
        ...
        if(selectAssembly.getSelectedItemPosition() == 0 || selectAssembly.getSelectedItemPosition() == 1){
            Toast.makeText(postAd.this, "Select Assembly",Toast.LENGTH_SHORT).show();
        ...
        if(engineCapacity.getSelectedItemPosition() == 0 || engineCapacity.getSelectedItemPosition() == 1){
            Toast.makeText(postAd.this, "Select Engine Capacity",Toast.LENGTH_SHORT).show();
        ...
        if(selectCondition.getSelectedItemPosition() == 0 || selectCondition.getSelectedItemPosition() == 1){
            Toast.makeText(postAd.this, "Select Condition",Toast.LENGTH_SHORT).show();
            selectCondition.setFocusable(true);
            selectCondition.setFocusableInTouchMode(true);
            selectCondition.requestFocus();
            selectCondition.performClick();
            return;
        }

        if(imagesEncodedList == null){
            Toast.makeText(postAd.this, "Please add atleast 3 Photos of your car.",Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        RequestBody condition =
                RequestBody.create(MediaType.parse("multipart/form-data"), selectCondition.getSelectedItem().toString());
        ...
        compositeDisposable.add(iMyService.createPost(token,id,photo1,photo2,photo3,
                title1,
                city1,
                make,
                model,
                ...
                .subscribe(new Consumer<Object>() {
                    ...
                    public void accept(Object response) throws Exception {
                        ...
                        String postID = jsonObject.getJSONObject("result").getString("_id");
                        mDialog.dismiss();

                        Intent intent1 = new Intent(postAd.this, reviewAdToPost.class);
                        intent1.putExtra("postID", postID);
                        startActivity(intent1);
                        overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);


//                        Toast.makeText(postAd.this, jsonObject.toString(), Toast.LENGTH_LONG).show();
//                        video_title_Label.setText(jsonObject.toString());
...
//                        else {
//                            mDialog.dismiss();
//                            Toast.makeText(postAd.this, "Ad Posted.", Toast.LENGTH_SHORT).show();
//                            Intent intent1 = new Intent(postAd.this, MainActivity.class);
//                            startActivity(intent1);
//                            overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
//                            finish();
...
//    }
    ...
    public String getVideoFilePath(Uri uri) {
        ...
        Cursor cursor = getContentResolver().query(android.provider.MediaStore.Video.Media.EXTERNAL_CONTENT_URI, null, MediaStore.Video.Media._ID + " = ? ", new String[]{image_id}, null);
        if (cursor != null) {
            cursor.moveToFirst();
