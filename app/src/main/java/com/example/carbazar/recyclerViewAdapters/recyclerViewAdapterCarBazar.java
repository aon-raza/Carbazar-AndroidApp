...
public class recyclerViewAdapterCarBazar extends RecyclerView.Adapter<recyclerViewAdapterCarBazar.ViewHolder>  {
    ...
    public recyclerViewAdapterCarBazar(Context mContext, List<JSONObject> list) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_items_carbazar, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int i) {
        ...
        final JSONObject post = list.get(positionInlist);
        try {
