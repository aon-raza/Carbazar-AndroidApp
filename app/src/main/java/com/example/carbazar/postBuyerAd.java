...
public class postBuyerAd extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDialog = new ProgressDialog(postBuyerAd.this);
            ...
            public void onClick(View v) {
                if(isOnline()){
                    if(common.currentUser == null){
                        Toast.makeText(postBuyerAd.this, "Sign in first", Toast.LENGTH_SHORT).show();
                        Intent intent3 = new Intent(postBuyerAd.this, signin.class);
                    ...
                    Toast.makeText(postBuyerAd.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent1 = new Intent(postBuyerAd.this, postAd.class);
            ...
            compositeDisposable.add(iMyService.getMakes()
                    ...
                    .subscribe(new Consumer<Object>() {
                        ...
                        public void accept(Throwable throwable) throws Exception {
                            Toast.makeText(postBuyerAd.this, "Server Error!" +throwable.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }));
        }else{
            Toast.makeText(postBuyerAd.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.home_nav:
                //
                Intent intent = new Intent(postBuyerAd.this, MainActivity.class);
            ...
            case R.id.chatbot_nav:
                //
                Intent intent1 = new Intent(postBuyerAd.this, chatbot.class);
                startActivity(intent1);
                overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                return true;
            ...
            case R.id.ar_vr_nav:
                //
                Intent intent2 = new Intent(postBuyerAd.this, ARHome.class);
            ...
            case R.id.account_nav:
                //
                Intent intent3 = new Intent(postBuyerAd.this, account.class);
                startActivity(intent3);
                overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                return true;
    ...
    private void sendData(){
        if(title.getText().toString().contentEquals("") || title.getText().toString().length() < 4){
            Toast.makeText(postBuyerAd.this, "Enter a valid title",Toast.LENGTH_SHORT).show();
            title.requestFocus();
        ...
        if(city.getSelectedItemPosition() == 0 || city.getSelectedItemPosition() == 1){
            Toast.makeText(postBuyerAd.this, "Select your city",Toast.LENGTH_SHORT).show();
        ...
        if(selectMake.getSelectedItem() == null){
            Toast.makeText(postBuyerAd.this, "Select Make",Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(selectModel.getSelectedItemPosition() == 0 || selectModel.getSelectedItemPosition() == 1){
            Toast.makeText(postBuyerAd.this, "Select Model",Toast.LENGTH_SHORT).show();
        ...
        if(selectYear.getSelectedItemPosition() == 0 || selectYear.getSelectedItemPosition() == 1){
            Toast.makeText(postBuyerAd.this, "Select Year",Toast.LENGTH_SHORT).show();
        ...
        if(engineCapacity.getSelectedItemPosition() == 0 || engineCapacity.getSelectedItemPosition() == 1){
            Toast.makeText(postBuyerAd.this, "Select Engine Capacity",Toast.LENGTH_SHORT).show();
        ...
        if(imagesEncodedList == null){
            Toast.makeText(postBuyerAd.this, "Please add a Photo.",Toast.LENGTH_SHORT).show();
            return;
        }

        if(imagesEncodedList.size() < 1){
            Toast.makeText(postBuyerAd.this, "Please add a Photos.",Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        compositeDisposable.add(iMyService.createBuyersPost(token,id,photo1,
                title1,
                city1,
                make,
                model,
